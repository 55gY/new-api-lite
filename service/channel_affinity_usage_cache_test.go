...
var channelAffinityUsageCacheTestSeq int64

func nextChannelAffinityUsageCacheTestID() int64 {
	return atomic.AddInt64(&channelAffinityUsageCacheTestSeq, 1)
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	testID := nextChannelAffinityUsageCacheTestID()
