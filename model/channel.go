...
type Channel struct {
	...
	DisableAutoTest   *int    `json:"disable_auto_test" gorm:"default:0"`
...
func (channel *Channel) GetOtherInfo() map[string]interface{} {
	...
	if channel.OtherInfo != "" {
		...
		if err != nil {
			common.SysLog(fmt.Sprintf("failed to unmarshal other info: channel_id=%d, name=%s, error=%v", channel.Id, channel.Name, err))
		}
	}
	return otherInfo
}
...
func (channel *Channel) SetOtherInfo(otherInfo map[string]interface{}) {
	...
	if err != nil {
		common.SysLog(fmt.Sprintf("failed to marshal other info: channel_id=%d, name=%s, error=%v", channel.Id, channel.Name, err))
		return
	}
