...
- [.plan/20260731-01.md](.plan/20260731-01.md) — 渠道测试报错定位与测试报错中文化计划（已完成：定位 `invalid character '<'` 根因为上游 WAF 网页响应；新增网页响应拦截与测试报错中文化）
...
- [.plan/20260825-03.md](.plan/20260825-03.md) — 上游 P0 协议兼容性修复实施计划（已完成：定向/全量测试、隔离前端构建、后端构建及静态检查通过）
- [.plan/20260825-04.md](.plan/20260825-04.md) — 上游 P1 稳定性增强实施计划（已完成：请求体重放、AWS 断连取消、定向/全量测试、隔离构建及静态检查通过）
- [.plan/20260825-05.md](.plan/20260825-05.md) — 经典前端健壮性审计与修复计划（已完成：共享错误边界、API 拦截器、会话缓存回退、ESLint/Prettier 与隔离构建通过）
- [.plan/20260825-06.md](.plan/20260825-06.md) — 全库健康审计、完整测试与安全清理计划（已完成：全栈构建、Go race 修复、资源生命周期修复与审计报告）
- [.plan/20260825-07.md](.plan/20260825-07.md) — staticcheck P0 正确性修复与安全清理计划（已完成：Coze 解码、schema null 过滤、低风险残留清理及完整隔离回归）
...
- [.plan/20260826-01.md](.plan/20260826-01.md) — 58 条低风险 staticcheck 收尾计划（已完成：控制器、模型、DTO、中继、服务及类型化简；完整隔离回归通过）
- [.plan/20260826-02.md](.plan/20260826-02.md) — 对外错误文本风格警告处理计划（已完成：Codex/Vertex 渠道校验文本规范化及完整隔离回归）
- [.plan/20260826-03.md](.plan/20260826-03.md) — U1000 A 批立即删除清理计划（已完成：11 个实际符号单元清理、专属 import 清理及完整隔离回归）
- [.plan/20260826-04.md](.plan/20260826-04.md) — 剩余 23 条 U1000 专项清理计划（已完成：SQLite-only/Lite 边界残留删除、专项测试、完整隔离回归及 staticcheck 零诊断）
...
- [.plan/20260826-10.md](.plan/20260826-10.md) — 原生 Docker 管理面板与一键更新（已完成：交互菜单、非交互子命令、数据删除强确认、README 用法与模拟 Docker 回归）
- [.plan/20260903-01.md](.plan/20260903-01.md) — 渠道状态与模型列表可见性修复计划（实施中：按渠道 enabled 状态过滤模型、修复新增渠道默认可用并补充回归测试）
- [.plan/20260906-01.md](.plan/20260906-01.md) — 全局 API 限流设置开放计划（已完成：默认关闭、系统设置动态配置、前端速率限制表单、定向测试、中文提交及 GitHub 同步）
- [.plan/20260906-02.md](.plan/20260906-02.md) — 限制配置与前端开放性审计计划（已完成：扫描限制来源、核对前端入口并输出分级审计报告）
- [.plan/20260906-03.md](.plan/20260906-03.md) — 业务限制配置前端开放计划（本地完成：后端动态配置、前端入口和测试；未推送远程仓库）
- [.plan/20260906-04.md](.plan/20260906-04.md) — 限制配置开关保存异常修复计划（本地完成：修复 `Enable` 开关动态更新和前端旧状态覆盖；未推送远程仓库）
- [.plan/20260906-05.md](.plan/20260906-05.md) — 限制配置开关模板对齐修复计划（本地完成：按通用开关模板转换布尔值并统一 Form.Switch 参数；未推送远程仓库）
- [.plan/20260906-06.md](.plan/20260906-06.md) — 模型限流开关模板对齐计划（本地完成：按同页模型开关重构新增开关并完成验证；未推送远程仓库）
- [.plan/20260909-01.md](.plan/20260909-01.md) — auto 自动路由增强实施计划（进行中：候选集增量维护、防递归解析、短 TTL 最近成功、定时失效清理与 300 分钟默认值）
