...
import (
	...
	relaymedia "github.com/55gY/new-api-lite/service/relayconvert/internal/media"
	sharedclaude "github.com/55gY/new-api-lite/service/relayconvert/internal/shared/claude"
...
func OpenAIChatRequestToClaudeMessages(c *gin.Context, textRequest dto.GeneralOpenAIRequest) (*dto.ClaudeRequest, error) {
	...
	for _, tool := range textRequest.Tools {
		if _, hasObjectSchema := tool.Function.Parameters.(map[string]any); !hasObjectSchema && tool.Type != "function" {
			continue
		}
