...
- [.plan/20260815-02.md](.plan/20260815-02.md) — 受限第三方渠道签到任务实施计划（已完成：任务管理、渠道关联、受限调度与静态/Go 验证完成；Bun 生产构建受沙箱资源限制中止）
- [.plan/20260815-03.md](.plan/20260815-03.md) — 签到任务主体功能续作计划（已完成：调度状态、侧栏配置、任务 UI 与全量/静态验证已补齐）
- [.plan/20260815-04.md](.plan/20260815-04.md) — 渠道新增与编辑表单字段一致性审查计划（已完成：修复提交载荷、签到任务空关联和全量/静态验证）
- [.plan/20260815-05.md](.plan/20260815-05.md) — 签到任务绑定链路构建验证计划（已完成：后端全量测试与前端生产构建均通过）
- [.plan/20260825-01.md](.plan/20260825-01.md) — 签到任务完整撤销计划（进行中）
