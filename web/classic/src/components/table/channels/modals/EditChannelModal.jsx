  ...
  const handleInputChange = (name, value) => {
    ...
    if (name === 'name') {
      ...
      const shouldFillBaseUrl =
        /^https?:\/\//i.test(trimmedName) && !baseUrlManuallyChangedRef.current;
      setInputs((inputs) => ({
        ...inputs,
        [name]: value,
                ...
                {MODEL_FETCHABLE_CHANNEL_TYPES.has(inputs.type) && (
                  <div className='pb-3 border-b border-gray-100'>
                    ...
                    <Form.Input
                      ...
                      label={t('已忽略模型')}
                      placeholder={t('例如：gpt-4.1-nano,regex:^claude-.*$')}
                      extraText={t(
                            ...
                            onClick={() =>
                              handleInputChange(
                                ...
                                JSON.stringify(
                                  {
                                    'User-Agent':
                                      'claude-cli/2.1.39 (external, cli)',
                                    'x-app': 'cli',
                                    'anthropic-beta':
